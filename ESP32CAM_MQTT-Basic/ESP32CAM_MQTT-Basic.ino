...
//Datos de WiFi
<<<<<<< HEAD
const char* ssid = "HP-O3A";  // Aquí debes poner el nombre de tu red
const char* password = "67894Qko";  // Aquí debes poner la contraseña de tu red
=======
...
>>>>>>> 0f9c8f633b8eb5d1993d53a0e90d9a9a2c85beff
